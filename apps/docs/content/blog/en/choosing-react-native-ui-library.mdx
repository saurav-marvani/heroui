...
description: "A practical framework for choosing a React Native UI library, and where Kinetic Native fits."
date: "2026-05-12"
...
This guide explains how we think about that decision, and why Kinetic Native is built the way it is.
...
Kinetic Native takes the package approach:
...
Kinetic Native is intentionally opinionated about the baseline:
...
Kinetic Native is strongest when you want one ecosystem across product surfaces:

- Web product: [Kinetic React](/docs/react/getting-started/quick-start)
- Mobile product: [Kinetic Native](/docs/native/getting-started)
- Premium app surfaces: [Kinetic Pro](https://kinetic-ui.com/pro)
- Design handoff: [Kinetic Figma Kit V3](https://www.figma.com/community/file/1546526812159103429/heroui-figma-kit-v3)
...
## Where Kinetic Native Is Different

Kinetic Native is built specifically for React Native. It does not ask you to use web imports or CSS files that do not belong in mobile apps.
...
Do not use the Kinetic web package or web-only event handlers in React Native screens.

Kinetic Native uses `onPress`, `KineticNativeProvider`, `GestureHandlerRootView`, Uniwind, and native overlay/portal patterns because those are the right abstractions for mobile.

## Recommendation

Choose Kinetic Native when your team values design quality, maintainability, and ecosystem leverage. It is especially compelling if you already use Kinetic on the web, work from Figma, or build with AI coding assistants.
