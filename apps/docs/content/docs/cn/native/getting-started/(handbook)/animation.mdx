---
title: 动画
description: 为 Kinetic Native 组件添加流畅动画与过渡
icon: copy-transparent
---

Kinetic Native 的动画基于 [react-native-reanimated](https://docs.swmansion.com/react-native-reanimated/)，手势由 [react-native-gesture-handler](https://docs.swmansion.com/react-native-gesture-handler/) 处理。若需更细粒度控制，建议先熟悉二者。
...
在 `KineticNativeProvider` 上统一关闭应用内全部 Kinetic Native 动画：
