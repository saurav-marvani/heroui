---
title: LLMs.txt
description: 让 Claude、Cursor、Windsurf 等 AI 助手理解 Kinetic Native 文档
---

我们提供 [LLMs.txt](https://llmstxt.org/) 文件，便于 AI 编程助手读取 Kinetic Native 文档。
...
- [/native/llms-full.txt](/native/llms-full.txt) — Kinetic Native 完整文档
