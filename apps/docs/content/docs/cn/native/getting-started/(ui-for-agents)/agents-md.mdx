---
title: AGENTS.md
description: 将 Kinetic Native 文档下载到项目中，供 AI 编程助手引用
icon: preview
---

可将 Kinetic Native 文档直接下载到项目内，供 AI 助手本地引用。

<Callout>
  **说明：** `agents-md` 命令专用于 **Kinetic React v3** 与 **Kinetic Native**。其他 CLI 命令（如 `add`、`init`、`upgrade` 等）目前仍面向 Kinetic v2。
</Callout>
...
- 将最新 Kinetic Native 文档下载到 `.heroui-docs/native/`
