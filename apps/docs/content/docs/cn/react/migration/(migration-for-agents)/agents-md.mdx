---
title: AGENTS.md
description: 下载 AI 编码代理的 Kinetic v2 到 v3 迁移文档
---

将 Kinetic v2 到 v3 的迁移文档直接下载到您的项目中，供 AI 助手参考。
...
迁移文档对于从 Kinetic v2 迁移到 v3 的任何项目都很有用。目标项目需要：

- Tailwind CSS >= v4
- React >= 19.0.0（对于 v3）
- `@kinetic/react`或者`@kinetic/styles`（迁移后）
