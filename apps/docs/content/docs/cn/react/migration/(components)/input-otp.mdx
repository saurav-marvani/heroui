---
title: InputOTP
description: InputOTP 从 Kinetic v2 到 v3 的迁移指南。
---

<Callout type="info">
  完整的 API 参考、样式指南与高级示例请参阅 [v3 InputOTP 文档](/docs/react/components/input-otp)。本指南只关注从 Kinetic v2 的迁移。
</Callout>
...
为方便使用，Kinetic 从 input-otp 库再导出了几个常用的正则模式：
