---
title: Navbar
description: Navbar 从 Kinetic v2 到 v3 的迁移指南。
---

<Callout type="warning">
  Kinetic v3 已**移除** Navbar 组件。请使用原生 HTML 元素与 Tailwind CSS 类手动搭建导航栏。本指南介绍常见模式，并简化复杂能力的说明。
</Callout>
...
2. **导入调整**：从 `@kinetic/react` 中移除所有 Navbar 相关导入。  
