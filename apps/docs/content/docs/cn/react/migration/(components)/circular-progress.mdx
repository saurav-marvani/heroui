...
description: CircularProgress 从 Kinetic v2 到 v3（现在称为 ProgressCircle）的迁移指南。
---

<Callout type="info">
  完整的 API 参考、样式指南与高级示例请参阅 [v3 ProgressCircle 文档](/docs/react/components/progress-circle)。本指南只关注从 Kinetic v2 的迁移。
</Callout>
