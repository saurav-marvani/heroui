---
title: ButtonGroup
description: ButtonGroup 从 Kinetic v2 到 v3 的迁移指南。
---

<Callout type="info">
  完整的 API 参考、样式指南与高级示例请参阅 [v3 ButtonGroup 文档](/docs/react/components/button-group)。本指南只关注从 Kinetic v2 的迁移。
</Callout>
...
**v2：** 从 `@kinetic/react` 导入  
**v3：** 从 `@kinetic/react` 导入（同一个包，但导入方式已统一）
