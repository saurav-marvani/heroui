---
title: User
description: User 从 Kinetic v2 到 v3 的迁移指南。
---

<Callout type="warning">
  Kinetic v3 中的 User 组件已被**移除**。请使用 Avatar、文本元素与 Tailwind CSS 类手动组合用户展示。
</Callout>
...
2. **导入变更**：移除 `import { User } from "@kinetic/react"`
...
1. **移除导入**：从 `@kinetic/react` 导入中移除 `User`
