---
title: 设计原则
description: 指导 Kinetic v3 设计和开发的核心原则
icon: book
---

Kinetic v3 遵循 10 项核心原则，注重清晰度、无障碍、可定制性以及开发者体验。
...
样式（`@kinetic/styles`）与逻辑（`@kinetic/react`）相互分离，可与任何框架或纯 HTML 一同使用。参见 [Tailwind Play 示例](https://play.tailwindcss.com/vMYXzKPyUx)。
