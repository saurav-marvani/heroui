---
title: LLMs.txt
description: 让 Claude、Cursor、Windsurf 等 AI 助手理解 Kinetic v3
---

我们提供 [LLMs.txt](https://llmstxt.org/) 文件，让 AI 编码助手可以访问 Kinetic v3 文档。

## 可用文件

**核心文档：**
- [/react/llms.txt](/react/llms.txt) — React 文档的快速参考索引
- [/react/llms-full.txt](/react/llms-full.txt) — 完整的 Kinetic React 文档
