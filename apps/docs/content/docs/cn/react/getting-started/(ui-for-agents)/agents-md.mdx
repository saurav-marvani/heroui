---
title: AGENTS.md
description: 为 AI 编码代理下载 Kinetic v3 React 文档
icon: preview
---

将 Kinetic v3 React 文档直接下载到你的项目中，供 AI 助手参考。

<Callout>
  **注意：** `agents-md` 命令专门用于 Kinetic React v3。其他 CLI 命令（如 `add`、`init`、`upgrade` 等）目前仍用于 Kinetic v2。
</Callout>
...
- 将最新的 Kinetic v3 React 文档下载到 `.heroui-docs/react/`
