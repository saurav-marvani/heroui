...
Kinetic is a React component library built on [Tailwind CSS v4](https://tailwindcss.com/) and [React Aria Components](https://react-spectrum.adobe.com/react-aria/index.html). Every component comes with smooth animations, polished details, and built-in accessibility—ready to use, fully customizable.
...
Kinetic is different. It's a living library that grows with you:
...
Kinetic v3 is not a snapshot—it's a garden that keeps growing. 🌱

## Kinetic Ecosystem

- **🌐 Kinetic v3** (web) — You're here! React components with Tailwind CSS v4
- **📱 [Kinetic Native](https://link.kinetic-ui.com/native)** (mobile) — Beautiful components for React Native
- **🤖 [Kinetic Chat](https://heroui.chat?ref=heroui-v3)** (text-to-app) — Create apps with natural language
- **🧠 UI for LLMs** — New platform & MCPs coming soon

**Why React Aria?** We chose React Aria for accessibility at scale. We've used it since Kinetic v2, and v3 keeps familiar API conventions like `isDisabled` and `onPress`. Thanks to [Devon Govett](https://x.com/devongovett) and the Adobe team.
...
Yes. Kinetic v3 is stable and ready for production use.
...
Yes! Access our design system at [Kinetic Figma Kit V3](https://www.figma.com/community/file/1546526812159103429).
...
Kinetic is released under the [Apache License 2.0](https://github.com/heroui-inc/heroui/blob/main/LICENSE).
