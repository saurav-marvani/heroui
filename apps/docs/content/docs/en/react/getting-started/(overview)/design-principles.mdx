...
description: Core principles that guide Kinetic v3's design and development
icon: book
---

Kinetic v3 follows 10 core principles that prioritize clarity, accessibility, customization, and developer experience.
...
```tsx
import { Tabs, TabList, Tab, TabPanel } from '@kinetic/react';
...
import { Alert, AlertIcon, CardHeader, AccordionTrigger } from '@kinetic/react';
...
Styles (`@kinetic/styles`) are separate from logic (`@kinetic/react`), enabling use with any framework or vanilla HTML. See [Tailwind Play example](https://play.tailwindcss.com/vMYXzKPyUx).
...
// Apply Kinetic's BEM classes directly to any element
...
## Comparison with Kinetic v2

| Aspect | Kinetic v2 | Kinetic v3 |
|--------|-----------|-----------|
