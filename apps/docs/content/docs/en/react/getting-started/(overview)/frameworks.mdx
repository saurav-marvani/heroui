---
title: Frameworks
description: Integrate Kinetic with your framework
icon: layers
---
...
### 2. Use your first Kinetic component
    ...
    export default function HomePage() {
      return (
        <main className="flex min-h-screen items-center justify-center">
          <Button variant="tertiary">Hello Kinetic</Button>
        </main>
      );
    }
    ```
...
<Callout>
  Kinetic v3 does not require a provider. Components work directly after installation and style import.
</Callout>
...
import {isRTL} from '@kinetic/react';
...
import {I18nProvider} from '@kinetic/react';
