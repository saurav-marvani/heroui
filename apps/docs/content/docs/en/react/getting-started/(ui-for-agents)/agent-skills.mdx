---
title: Agent Skills
description: Enable AI assistants to build UIs with Kinetic v3 components
---

Kinetic Skills give your AI assistant comprehensive knowledge of Kinetic v3 components, patterns, and best practices.
...
```bash
curl -fsSL https://kinetic-ui.com/install | bash -s heroui-react
```
...
- Build components using Kinetic v3
- Create pages with Kinetic components
...
- Kinetic v3 installation guide
- All Kinetic v3 components with props, examples, and usage patterns
