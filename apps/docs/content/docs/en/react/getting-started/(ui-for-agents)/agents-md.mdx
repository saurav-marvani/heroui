---
title: AGENTS.md
description: Download Kinetic v3 React documentation for AI coding agents
icon: preview
---

Download Kinetic v3 React documentation directly into your project for AI assistants to reference.

<Callout>
  **Note:** The `agents-md` command is specifically for Kinetic React v3. Other CLI commands (like `add`, `init`, `upgrade`, etc.) are for Kinetic v2 (for now).
</Callout>
...
<DocsImage
  ...
  alt="Kinetic React v3 AGENTS.md"
/>
...
- Downloads latest Kinetic v3 React docs to `.heroui-docs/react/`
