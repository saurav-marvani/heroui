---
title: Migration
description: Complete guide to migrate your Kinetic v2 application to v3
index: true
---

## For AI Assistants

Below are three approaches for AI assistants to access migration documentation. ***We recommend using the Kinetic Migration MCP server*** and leveraging its prompts and tools, but all options provide agents with the complete documentation.
...
- **Dependencies**: Update React to v19+, Kinetic packages to v3, Tailwind CSS to v4, remove Framer Motion
- **No Provider Required**: v3 removes the need for `KineticProvider`
...
Kinetic v2 and v3 cannot coexist in the same project without special setup. You have two migration approaches to choose from:
