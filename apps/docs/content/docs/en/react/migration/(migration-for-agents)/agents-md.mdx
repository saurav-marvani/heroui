---
title: AGENTS.md
description: Download Kinetic v2 to v3 migration docs for AI coding agents
---

Download Kinetic v2 to v3 migration documentation directly into your project for AI assistants to reference.
...
Migration docs are useful for any project migrating from Kinetic v2 to v3. The target project needs:

- Tailwind CSS >= v4
- React >= 19.0.0 (for v3)
- `@kinetic/react` or `@kinetic/styles` (after migration)
