---
title: Agent Skills
description: Enable AI assistants to migrate Kinetic v2 to v3
---

Kinetic Migration Skills give your AI assistant comprehensive knowledge of Kinetic v2 to v3 migration workflows, component guides, and best practices.

### Installation

```bash
curl -fsSL https://kinetic-ui.com/install | bash -s heroui-migration
```
...
- Migrate components from Kinetic v2 to v3
