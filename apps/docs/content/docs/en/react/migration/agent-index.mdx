...
description: Entry point for AI assistants helping migrate Kinetic v2 to v3
index: false
---

For AI assistants: use this as the entry point when helping migrate Kinetic v2 → v3.
