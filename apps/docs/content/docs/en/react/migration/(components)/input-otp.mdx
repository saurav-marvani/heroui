---
title: InputOTP
description: Migration guide for InputOTP from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 InputOTP documentation](/docs/react/components/input-otp) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { REGEXP_ONLY_CHARS } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Description, FieldError } from "@kinetic/react";
...
Kinetic re-exports common regex patterns from the input-otp library for convenience:
