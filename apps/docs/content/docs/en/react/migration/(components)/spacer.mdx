---
title: Spacer
description: Migration guide for Spacer from Kinetic v2 to v3
---

<Callout type="warning">
  The Spacer component has been **removed** in Kinetic v3. Use Tailwind CSS margin utilities directly instead.
</Callout>
...
**v2:** `<Spacer>` component from `@kinetic/react`  
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer, Button } from "@kinetic/react";
...
2. **Import Change**: Remove `import { Spacer } from "@kinetic/react"`
...
1. **Remove Import**: Remove `Spacer` from `@kinetic/react` imports
