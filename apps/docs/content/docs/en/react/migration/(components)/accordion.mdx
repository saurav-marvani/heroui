---
title: Accordion
description: Migration guide for Accordion from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Accordion documentation](/docs/react/components/accordion) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Accordion, AccordionItem } from "@kinetic/react";
