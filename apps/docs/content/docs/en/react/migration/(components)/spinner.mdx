---
title: Spinner
description: Migration guide for Spinner from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Spinner documentation](/docs/react/components/spinner) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
