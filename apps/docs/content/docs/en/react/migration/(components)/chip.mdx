---
title: Chip
description: Migration guide for Chip from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Chip documentation](/docs/react/components/chip) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Avatar, Chip } from "@kinetic/react";
