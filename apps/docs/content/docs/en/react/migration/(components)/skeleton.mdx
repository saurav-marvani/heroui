---
title: Skeleton
description: Migration guide for Skeleton from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Skeleton documentation](/docs/react/components/skeleton) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
