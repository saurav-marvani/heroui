---
title: Progress
description: Migration guide for Progress from Kinetic v2 to v3 (now ProgressBar)
---

<Callout type="info">
  Refer to the [v3 ProgressBar documentation](/docs/react/components/progress-bar) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Progress } from "@kinetic/react";
