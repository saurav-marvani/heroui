---
title: Dropdown
description: Migration guide for Dropdown from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Dropdown documentation](/docs/react/components/dropdown) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    import { Label, Description, Kbd } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Kbd } from "@kinetic/react";
