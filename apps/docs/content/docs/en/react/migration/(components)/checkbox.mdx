---
title: Checkbox
description: Migration guide for Checkbox from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Checkbox documentation](/docs/react/components/checkbox) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Checkbox, Label, Description } from "@kinetic/react";
