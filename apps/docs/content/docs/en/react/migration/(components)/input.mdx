---
title: Input
description: Migration guide for Input from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Input documentation](/docs/react/components/input) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { TextField, Label, Input, FieldError } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { InputGroup } from "@kinetic/react";
