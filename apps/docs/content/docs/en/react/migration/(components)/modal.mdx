---
title: Modal
description: Migration guide for Modal from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Modal documentation](/docs/react/components/modal) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3 (Button trigger)", "v3 (Modal.Trigger)"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, Button, useDisclosure } from "@kinetic/react";
  ...
  <Tab value="v3 (Modal.Trigger)">
    ```tsx
    import { Modal } from "@kinetic/react";
...
<Tabs items={["v2", "v3 (useState)", "v3 (useOverlayState)", "v3 (state prop)"]}>
  <Tab value="v2">
    ```tsx
    import { useDisclosure } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, useDisclosure } from "@kinetic/react";
