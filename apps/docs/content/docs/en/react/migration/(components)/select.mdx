---
title: Select
description: Migration guide for Select from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Select documentation](/docs/react/components/select) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Select, SelectItem } from "@kinetic/react";
...
```tsx
import { Select, Label, ListBox } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Description, FieldError } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Select, SelectItem, SelectSection } from "@kinetic/react";
  ...
  <Tab value="v3">
    ```tsx
    import { Select, Label, ListBox, Header, Separator } from "@kinetic/react";
