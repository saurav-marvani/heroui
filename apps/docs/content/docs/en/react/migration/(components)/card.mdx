---
title: Card
description: Migration guide for Card from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Card documentation](/docs/react/components/card) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Card, CardHeader, CardBody, CardFooter } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Card, CardFooter, Image, Button } from "@kinetic/react";
