---
title: Tabs
description: Migration guide for Tabs from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Tabs documentation](/docs/react/components/tabs) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Tabs, Tab } from "@kinetic/react";
