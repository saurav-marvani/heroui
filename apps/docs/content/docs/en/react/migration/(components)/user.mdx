---
title: User
description: Migration guide for User from Kinetic v2 to v3
---

<Callout type="warning">
  The User component has been **removed** in Kinetic v3. Compose user displays manually using Avatar and text elements with Tailwind CSS classes.
</Callout>
...
**v2:** `<User>` component from `@kinetic/react`  
...
```tsx
import { User } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { User, Link } from "@kinetic/react";
...
2. **Import Change**: Remove `import { User } from "@kinetic/react"`
...
1. **Remove Import**: Remove `User` from `@kinetic/react` imports
