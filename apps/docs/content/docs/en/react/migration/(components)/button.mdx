---
title: Button
description: Migration guide for Button from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Button documentation](/docs/react/components/button) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
