---
title: Switch
description: Migration guide for Switch from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Switch documentation](/docs/react/components/switch) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { SwitchGroup } from "@kinetic/react";
