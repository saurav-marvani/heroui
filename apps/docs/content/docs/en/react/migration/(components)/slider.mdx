---
title: Slider
description: Migration guide for Slider from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Slider documentation](/docs/react/components/slider) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Slider } from "@kinetic/react";
...
```tsx
import { Slider, Label } from "@kinetic/react";
