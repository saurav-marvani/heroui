---
title: Alert
description: Migration guide for Alert from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Alert documentation](/docs/react/components/alert) for complete API reference, styling guide, and advanced examples.  This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Alert, CloseButton } from "@kinetic/react";
