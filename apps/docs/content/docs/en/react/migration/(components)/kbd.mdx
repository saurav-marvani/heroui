---
title: Kbd
description: Migration guide for Kbd from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Kbd documentation](/docs/react/components/kbd) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
