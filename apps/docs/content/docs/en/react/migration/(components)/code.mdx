---
title: Code
description: Migration guide for Code from Kinetic v2 to v3
---

<Callout type="warning">
  The Code component has been **removed** in Kinetic v3. Use native HTML `<code>` element with Tailwind CSS classes instead.
</Callout>
...
**v2:** `<Code>` component from `@kinetic/react`  
...
```tsx
import { Code } from "@kinetic/react";

export default function App() {
  return <Code>npm install @kinetic/react</Code>;
}
```
    ...
    export default function App() {
      return (
        <div className="space-y-4">
          <p>
            Install Kinetic with <Code>npm install @kinetic/react</Code>
          </p>
...
2. **Import Change**: Remove `import { Code } from "@kinetic/react"`
...
1. **Remove Import**: Remove `Code` from `@kinetic/react` imports
