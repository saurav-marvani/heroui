---
title: Tooltip
description: Migration guide for Tooltip from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Tooltip documentation](/docs/react/components/tooltip) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
