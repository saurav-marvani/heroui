---
title: ButtonGroup
description: Migration guide for ButtonGroup from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 ButtonGroup documentation](/docs/react/components/button-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
**v2:** Imported from `@kinetic/react`  
**v3:** Imported from `@kinetic/react` (same package, but unified import)
