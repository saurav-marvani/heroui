---
title: Table
description: Migration guide for Table from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Table documentation](/docs/react/components/table) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Table, Checkbox } from "@kinetic/react";
