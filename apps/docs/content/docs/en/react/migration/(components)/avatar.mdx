---
title: Avatar
description: Migration guide for Avatar from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Avatar documentation](/docs/react/components/avatar) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Avatar, AvatarGroup } from "@kinetic/react";
