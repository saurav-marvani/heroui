---
title: CheckboxGroup
description: Migration guide for CheckboxGroup from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 CheckboxGroup documentation](/docs/react/components/checkbox-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
