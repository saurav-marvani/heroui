---
title: RadioGroup
description: Migration guide for RadioGroup from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 RadioGroup documentation](/docs/react/components/radio-group) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
...
```tsx
import { RadioGroup, Radio } from "@kinetic/react";
...
```tsx
import { RadioGroup, Radio, Label, Description } from "@kinetic/react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { RadioGroup, Radio, Label } from "@kinetic/react";
