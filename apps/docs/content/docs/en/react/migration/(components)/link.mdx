---
title: Link
description: Migration guide for Link from Kinetic v2 to v3
---

<Callout type="info">
  Refer to the [v3 Link documentation](/docs/react/components/link) for complete API reference, styling guide, and advanced examples. This guide only focuses on migrating from Kinetic v2.
</Callout>
