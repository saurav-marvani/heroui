---
title: Image
description: Migration guide for Image from Kinetic v2 to v3
---

<Callout type="warning">
  The Image component has been **removed** in Kinetic v3. Use native HTML `<img>` element or Next.js `Image` component with Tailwind CSS classes instead.
</Callout>
...
**v2:** `<Image>` component from `@kinetic/react`  
...
```tsx
import { Image } from "@kinetic/react";
...
2. **Import Change**: Remove `import { Image } from "@kinetic/react"`
...
1. **Remove Import**: Remove `Image` from `@kinetic/react` imports
