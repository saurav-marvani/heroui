...
```tsx
import { TimeField } from '@kinetic/react';
```
...
```tsx
import {TimeField, Label, Description, FieldError} from '@kinetic/react';
...
```tsx
import {TimeField, Label, Description} from '@kinetic/react';
...
- **TimeField.Input** - Input component with segmented editing from `@kinetic/react`
