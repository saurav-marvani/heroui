...
```tsx
import { ListBox } from '@kinetic/react';
```
...
```tsx
import { ListBox, Label, Description, Header } from '@kinetic/react';
...
```tsx
import { ListBox, Label, Description } from '@kinetic/react';
...
<ListBox aria-label="Users" selectionMode="single">
  ...
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@kinetic-ui.com</Description>
  </ListBox.Item>
</ListBox>
```
...
```tsx
import { ListBox, Header, Separator } from '@kinetic/react';
...
```tsx
import { ListBox, Selection } from '@kinetic/react';
...
```tsx
import { ListBox, ListBoxItemIndicator } from '@kinetic/react';
