...
**Before:**
```tsx
import { Switch, Label, Description } from '@kinetic/react';
...
`DateInputGroup` and `ColorInputGroup` are no longer exported directly from `@kinetic/react`. Their sub-components have been consolidated under their respective field components (`DateField`, `TimeField`, `ColorField`).

#### DateField Changes

**Before:**
```tsx
import {DateField, Label, DateInputGroup, Description} from '@kinetic/react';
...
**After:**
```tsx
import {DateField, Label, Description} from '@kinetic/react';
...
```tsx
import {ColorField, Label, ColorInputGroup, ColorSwatch} from '@kinetic/react';
...
**After:**
```tsx
import {ColorField, Label, ColorSwatch} from '@kinetic/react';
