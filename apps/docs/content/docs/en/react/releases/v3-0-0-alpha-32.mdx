...
Kinetic now includes an [MCP server](/docs/ui-for-agents/mcp-server) that lets AI assistants like Cursor, Claude Code, and VS Code Copilot access Kinetic v3 documentation and component information directly.
...
3. **Update imports:**
   ...
   import {Card, CloseButton} from "@kinetic/react";
   ```
