...
```tsx
// Before
import type { SelectContentProps } from "@kinetic/react"

// After
import type { SelectPopoverProps } from "@kinetic/react"
```
...
```tsx
// Before
import { SelectContent } from "@kinetic/react"

// After
import { SelectPopover } from "@kinetic/react"
```
