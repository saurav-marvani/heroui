...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @kinetic/styles@alpha @kinetic/react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @kinetic/styles@alpha @kinetic/react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @kinetic/styles@alpha @kinetic/react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @kinetic/styles@alpha @kinetic/react@alpha
    ```
  </Tab>
</Tabs>
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@kinetic/react"`
...
You have two options for using Kinetic compound components:
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@kinetic/react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@kinetic/react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@kinetic/react"`
