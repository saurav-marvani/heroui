...
- **[Issue #232](https://github.com/heroui-inc/heroui-native/issues/232)**: Fixed KineticNativeProvider breaking with the recently released Uniwind Pro. The provider now properly handles Uniwind Pro compatibility, ensuring smooth integration with the latest Uniwind version.
