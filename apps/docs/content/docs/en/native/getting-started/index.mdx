...
**Is Kinetic Native free?**
Yes, completely free and open source under the Apache License 2.0.

**Is it production-ready?**
Yes, Kinetic Native is production-ready and actively used in production apps.
...
Kinetic Native is released under the [Apache License 2.0](https://github.com/heroui-inc/heroui-native/blob/main/LICENSE).
