---
title: LLMs.txt
description: Enable AI assistants like Claude, Cursor, and Windsurf to understand Kinetic Native
---

We provide [LLMs.txt](https://llmstxt.org/) files to make Kinetic Native documentation accessible to AI coding assistants.

## Available Files

**Core documentation:**
- [/native/llms.txt](/native/llms.txt) — Quick reference index for Native documentation
- [/native/llms-full.txt](/native/llms-full.txt) — Complete Kinetic Native documentation
...
```
Use Kinetic Native documentation from https://kinetic-ui.com/native/llms.txt
```
Or add to your project's `.claude` file for automatic loading.

**Cursor:** Use the `@Docs` feature:
```
@Docs https://kinetic-ui.com/native/llms-full.txt
```
...
```
https://kinetic-ui.com/native/llms.txt
```

**For component-specific documentation:**
```
https://kinetic-ui.com/native/llms-components.txt
```

**For patterns and best practices:**
```
https://kinetic-ui.com/native/llms-patterns.txt
```
