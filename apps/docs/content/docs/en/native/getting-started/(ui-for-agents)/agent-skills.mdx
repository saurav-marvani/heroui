---
title: Agent Skills
description: Enable AI assistants to build mobile UIs with Kinetic Native components
---

Kinetic Native Skills give your AI assistant comprehensive knowledge of Kinetic Native components, patterns, and best practices for React Native development.
...
<DocsImage
  ...
  alt="Kinetic Native Agent Skills"
/>

### Installation

```bash
curl -fsSL https://kinetic-ui.com/install | bash -s heroui-native
```
...
- Build mobile components using Kinetic Native
- Create screens with Kinetic Native components
...
- Kinetic Native installation guide
- All Kinetic Native components with props, examples, and usage patterns
