      ...
      <div className="mt-12 flex h-full flex-col items-center justify-center text-center md:mt-24">
        <div className="relative h-[275px] w-full max-w-[658px]">
          <Image
            ...
            height={275}
            quality={100}
            src="https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/docs/404_@2x.png"
            width={658}
          />
          <Image
            priority
            ...
            height={275}
            quality={100}
            src="https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/docs/404-dark_@2x.png"
            width={658}
          />
        </div>
