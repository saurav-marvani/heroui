...
const content: Record<HomeLocale, HomeContent> = {
  cn: {
    ...
    description:
      "Kinetic 是面向 Web 与移动端的现代 UI 库，助你快速迭代、保持一致，并打造令人愉悦的用户体验。",
    getStarted: "快速开始",
    ...
    releaseBadge: "Kinetic Native v1.0.5 — 补丁版本",
    title: (
      <>
  ...
  en: {
    ...
    description:
      "Kinetic is the modern UI library for web and mobile, built to help you move fast, stay consistent, and deliver delightful user experiences.",
    ...
    releaseBadge: "Kinetic Native v1.0.5 — patch release",
    title: (
      <>
