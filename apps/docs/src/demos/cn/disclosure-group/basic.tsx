...
import {Button, Disclosure, DisclosureGroup, Separator} from "@kinetic/react";
    ...
    <div className="w-full max-w-md">
      <div className="flex flex-col gap-4 bg-transparent p-4">
        <DisclosureGroup expandedKeys={expandedKeys} onExpandedChange={setExpandedKeys}>
          <Disclosure aria-label="预览 Kinetic Native" id="preview">
            <Disclosure.Heading>
              <Button
                slot="trigger"
            ...
            <Disclosure.Content>
              <Disclosure.Body className="mx-2 flex flex-col items-center gap-2 p-4 text-center">
                <p className="text-sm text-muted">
                  使用手机相机扫描此二维码，即可预览 Kinetic Native 组件。
                </p>
                <img
                  alt="Expo Go 二维码"
          ...
          <Disclosure id="download">
            <Disclosure.Heading aria-label="下载 Kinetic Native">
              <Button
                slot="trigger"
            ...
            <Disclosure.Content>
              <Disclosure.Body className="mx-2 flex flex-col items-center gap-2 p-4 text-center">
                <p className="text-sm text-muted">
                  下载 Kinetic Native 应用，即可在设备上直接体验我们的移动端组件。
                </p>
                <img
                  alt="App Store 二维码"
                  className="aspect-square w-full max-w-54 object-cover"
