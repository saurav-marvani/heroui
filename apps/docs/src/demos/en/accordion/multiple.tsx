  ...
  return (
    <Accordion allowsMultipleExpanded className="w-full max-w-md">
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Learn the basics of Kinetic and how to integrate it into your React project. This section
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            Understand the fundamental concepts behind Kinetic, including the compound component
      ...
      <Accordion.Item>
        ...
        <Accordion.Panel>
          <Accordion.Body>
            ...
            maintainable applications with Kinetic components.
          </Accordion.Body>
        </Accordion.Panel>
      </Accordion.Item>
    </Accordion>
