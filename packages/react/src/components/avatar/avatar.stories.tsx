...
const users = [
  {
    id: 1,
    image_url: "https://img.kinetic.chat/image/avatar?w=400&h=400&u=3",
    name: "John",
  },
  {
    id: 2,
    image_url: "https://img.kinetic.chat/image/avatar?w=400&h=400&u=5",
    name: "Kate",
  },
  {
    id: 3,
    image_url: "https://img.kinetic.chat/image/avatar?w=400&h=400&u=20",
    name: "Emily",
  },
  {
    id: 4,
    image_url: "https://img.kinetic.chat/image/avatar?w=400&h=400&u=23",
    name: "Michael",
  },
  {
    id: 5,
    image_url: "https://img.kinetic.chat/image/avatar?w=400&h=400&u=16",
    name: "Olivia",
  },
];
...
const circles = [
  ...
  {
    id: 4,
    image_url: "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/white.jpg",
    name: "W",
  },
  {
    id: 5,
...
const Template = ({color, size}: Avatar["RootProps"]) => (
  <div className="flex items-start gap-4">
    ...
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image alt="John Doe" src="https://img.kinetic.chat/image/avatar?w=400&h=400&u=3" />
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image alt="Paul" src="https://img.kinetic.chat/image/avatar?w=400&h=400&u=8" />
    ...
    <div className="flex flex-col gap-4">
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="White"
          src="https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/white.jpg"
        />
      ...
      <Avatar color={color} size={size}>
        <Avatar.Image
          alt="Black"
          src="https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg"
        />
...
const TemplateWithDelay = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      <Avatar color={color} size={size}>
        <Avatar.Image
          src={`https://app.requestly.io/delay/${delay}/https://img.kinetic.chat/image/avatar?w=400&h=400&u=3`}
        />
      </Avatar>
    </div>
  );
...
export const Sizes = {
  render: () => (
    <div className="flex items-center gap-4">
      <Avatar size="sm">
        <Avatar.Image alt="Small" src="https://img.kinetic.chat/image/avatar?w=400&h=400&u=3" />
        <Avatar.Fallback>SM</Avatar.Fallback>
      </Avatar>
      <Avatar size="md">
        <Avatar.Image alt="Medium" src="https://img.kinetic.chat/image/avatar?w=400&h=400&u=4" />
        <Avatar.Fallback>MD</Avatar.Fallback>
      </Avatar>
      <Avatar size="lg">
        <Avatar.Image alt="Large" src="https://img.kinetic.chat/image/avatar?w=400&h=400&u=5" />
...
const VariantsTemplate = (props: AvatarRootProps) => {
  ...
  const variants = [
    ...
    {label: "icon soft", type: "icon-soft", content: <Icon icon="gravity-ui:person" />},
    {
      ...
      type: "img",
      content: [
        "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/blue.jpg",
        "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/black.jpg",
        "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/green.jpg",
        "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/orange.jpg",
        "https://kinetic-assets.nyc3.cdn.digitaloceanspaces.com/avatars/red.jpg",
      ],
    },
  ] as const;
