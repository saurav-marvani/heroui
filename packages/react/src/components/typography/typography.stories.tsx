...
export const InlineCode: Story = {
  render: () => (
    <div className="flex max-w-2xl flex-col gap-4">
      <Typography.Paragraph>
        Install the package with <Typography.Code>pnpm add @kinetic/react</Typography.Code> and
  ...
  render: () => (
    <article className="flex max-w-2xl flex-col gap-4">
      ...
      <Typography.Paragraph>
        ...
        standard — and derive heading sizes using a consistent ratio. Kinetic uses a tracking-tight
      ...
      <Typography.Paragraph color="muted" size="sm">
        ...
        readability. These defaults work out of the box with Kinetic's Typography primitive.
      </Typography.Paragraph>
    </article>
  ),
};
...
export const ProseBlock: Story = {
  render: () => (
    <Typography.Prose className="max-w-2xl">
      <h1>Getting Started with Kinetic</h1>
      <p>
        Kinetic is a modern React component library built on top of <strong>Tailwind CSS v4</strong>{" "}
      ...
      <p>
        ...
        <code>@kinetic/react</code> package includes every component:
      </p>
      <pre>
        <code>pnpm add @kinetic/react</code>
      </pre>
      ...
      <h2>Next Steps</h2>
      <p>
        Explore the <a href="https://kinetic-ui.com">component stories</a> in Storybook to see every
