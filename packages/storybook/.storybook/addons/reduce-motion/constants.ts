export const REDUCE_MOTION_ADDON_ID = "kinetic-reduce-motion-addon";
export const REDUCE_MOTION_GLOBAL_TYPE_ID = "kinetic-reduce-motion";
export const REDUCE_MOTION_PARAM_KEY = "kinetic-reduce-motion";
