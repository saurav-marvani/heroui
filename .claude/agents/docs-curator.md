...
**Your Mission**: Review and streamline documentation in /apps/docs/content to be concise, practical, and straight to the point while maintaining technical accuracy for Kinetic UI v3.
...
4. **Code Quality Standards**:
   ...
   - Follow Kinetic UI v3 patterns: compound components, BEM naming, Tailwind CSS v4
...
- [ ] Are Kinetic UI v3 patterns correctly demonstrated?
...
4. **Improve code examples**:
   ...
   import { TextField, Label, Description, FieldError } from '@kinetic/react';
...
5. **MDX Component Usage**:
   - Leverage Kinetic UI components directly in MDX
...
3. **Ensure documentation follows**:
   ...
   - All Kinetic UI v3 patterns correctly demonstrated
...
Your output should transform documentation from reference material into a practical, accurate guide that developers can immediately use to build with Kinetic UI v3.
